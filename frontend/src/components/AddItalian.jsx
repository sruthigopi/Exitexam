...
const AddItalian = (props) => {
  ...
  axios.post("http://localhost:3008/addrecipeeita",inp)
  .then((response)=>{
  ...
  .catch(err=>console.log(err));
    ...
    if(props.method==="put"){
      axios.put("http://localhost:3008/editrecipeeita/"+inp._id,inp)
      .then((response)=>{
    ...
    return (
      <div className='all'  >
        <Typography variant='h4' style={{color:'red',fontFamily:'cursive'}}>Add Italian Cuisine</Typography>
        <div className='frw' >
     <div className='fst'>
